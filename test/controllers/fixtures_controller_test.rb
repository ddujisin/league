...
class FixturesControllerTest < ActionController::TestCase
  ...
  test "should create fixture" do
    assert_difference('Fixture.count') do
      post :create, fixture: { away_id: @fixture.away_id, awaypoints: @fixture.awaypoints, home_id: @fixture.home_id, homepoints: @fixture.homepoints }
    end
  ...
  test "should update fixture" do
    patch :update, id: @fixture, fixture: { away_id: @fixture.away_id, awaypoints: @fixture.awaypoints, home_id: @fixture.home_id, homepoints: @fixture.homepoints }
    assert_redirected_to fixture_path(assigns(:fixture))
  end

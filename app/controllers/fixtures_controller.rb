class FixturesController < ApplicationController
  ...
  # GET /fixtures.json
  def index
    @fixtures = Fixture.all.paginate(page: params[:page], per_page: 5)
  end
  ...
  def new
    @fixture = Fixture.new
    @fixture = Fixture.includes(:home).all
    @fixture = Fixture.includes(:away).all
  end
  ...
  private
    ...
    def fixture_params
      params.require(:fixture).permit(:home_id, :homepoints, :away_id, :awaypoints)
    end
end
